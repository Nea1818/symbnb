...
class AdType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('slug', TextType::class, $this->getConfiguration("Chaine URL", "Adresse web créee automatiquement", [
                'required' => false
            ]))
            ...
            ->add('content', TextareaType::class, $this->getConfiguration("Description détaillée", "Contenu de l'annonce"))
