...
class Booking
{
    ...
    public function isBookableDates()
    {
        ...
        // Tableau qui contient les dates souhaitées sous formes de string
        $days = array_map($formatDay, $bookingDays);

        // Tableau qui contient les dates impossibles sous forme de string
        $notAvailable = array_map($formatDay, $notAvailableDays);

        // Boucle de comparaison des 2 tableaux de string
        foreach ($days as $day) {
    ...
    /**
     * Permet de récupérer un tableau des dates de la résa qu'on souhaite effectuer
     *
     * @return array Un tableau d'objets DateTime représentant les dates de réservations souhaitées
     */
