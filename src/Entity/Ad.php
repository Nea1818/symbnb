...
class Ad
{
    ...
    /**
     * @ORM\Column(type="text")
     * @Assert\Length(min=10, max=255, minMessage="Le titre doit faire plus de 20 caractères.")
     */
    private $content;
    ...
    {
        // Calculer la somme des rating
        $sum = array_reduce($this->comments->toArray(), function ($total, $comment) {
            return $total + $comment->getRating();
        }, 0);

        // Faire la division du nombre de rating pour avoir la moyenne
